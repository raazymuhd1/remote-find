...
const Signup = () => {
  return (
    <section className='h-screen w-screen flex flex-col justify-center bg-(--light-white)'>
        <div className='flex flex-col gap-[10px] lg:w-[30%] md:w-[40%] w-[80%] mx-auto min-h-[50%] bg-(--white) rounded-[1.3rem] p-[1.2rem]'>
            <div className='flex flex-col items-center gap-[1.3rem]'>
                <h2 className='text-center text-[clamp(1.3rem,2vmax,2rem)] font-bold'> Get more opportunities </h2>
