...
const Signup = () => {
  return (
    <section className='h-screen w-screen flex flex-col justify-center bg-(--light-white)'>
        <div className='flex flex-col gap-[1rem] lg:w-[30%] md:w-[40%] w-[80%] mx-auto min-h-[50%] bg-(--white) rounded-[1.3rem] p-[1.2rem]'>
            <article className='flex flex-col items-center gap-[1.3rem]'>
                <div className='flex flex-col items-center gap-[1rem] w-full'>
                    <h1 className='font-extrabold text-[clamp(1.1rem,2vmax,2rem)] text-(--bright-green)'> RemoteFind </h1>
            ...
            <article className="w-full flex flex-col items-center gap-[.7rem]">
                <button className='font-semibold w-full py-[5px] px-[10px] rounded-[1rem] bg-(--bright-green) text-(--white)'> Sign Up </button>
                <p className='underline italic text-(--grey) text-[clamp(.6rem,.8vmax,.8rem)]'> Already have an account? Login instead! </p>
            </article>
        </div>
    </section>
  )
