  ...
  return (
    <section className='auth_bg h-screen w-screen flex flex-col justify-center bg-(--light-white)'>
        <div className='flex flex-col gap-[1rem] z-[9] auth_shadows lg:w-[30%] md:w-[50%] w-[70%] mx-auto min-h-[50%] bg-(--light-white) rounded-[1.7rem] p-[1.2rem]'>
            <article className='flex flex-col items-center gap-[.8rem]'>
                ...
                <a 
                    ...
                    className='flex items-center rounded-[10px] bg-(--white) py-[5px] px-[10px] gap-[10px] cursor-pointer'>
                ...
                <div className='flex w-full items-center'>
                    ...
                    <h4 className='text-[clamp(.8rem,1vmax,1rem)] whitespace-nowrap font-semibold text-(--grey)'> Or { signup ? "Signup" : "Signin" } with email </h4>
                    <div className='h-[1px] w-[40%] bg-(--grey)' />
                </div>
            </article>
            ...
            <form 
                ...
                <article className="w-full flex flex-col items-center gap-[.7rem]">
                    <button 
                        ...
                        type="submit"
                        className='font-semibold w-full py-[5px] px-[10px] rounded-[1rem] bg-(--light-green) text-(--white) cursor-pointer hover:opacity-[.7] transition-[opacity,2s,ease-in-out] delay-100'> { signup ? "Sign Up" : "Sign In" } 
                    </button>
                    { signup ? 
                    <p 
                        onClick={() => {
