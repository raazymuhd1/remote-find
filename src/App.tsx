    ...
    <>
      ...
      <main className='w-full h-[90vh] flex md:flex-row flex-col'>
        ...
        <div 
          ...
          className='w-full md:hidden p-[10px] bg-(--grey) flex justify-center cursor-pointer sticky top-0'>
        ...
        <aside 
          ...
          className={`w-full fixed bottom-0 ${showSidebar ? "opacity-[1] rounded-[10px] h-[90vh] sidebar_mobile w-screen" : "w-0 h-0 opacity-[0]"}`}>
